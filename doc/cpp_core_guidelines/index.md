...
version: 2017-06-19
date: 2017-06-19
update: 2017-06-19T20:57:26UTC
layout: doc
categories: [documentation]
tags: [c++]
draft: false
published: true
permalink: /doc/cpp_core_guidelines/index
group: cppcoreguidelines
---

Version: {{ page.version | date: site.data.format.date_only }}<br>
Date: {{ page.date | date: site.data.format.date_only }}<br>
License: [Copyright (c) Standard C++ Foundation and its contributors](https://isocpp.org/about)<br>
Source: [https://github.com/isocpp/CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines)<br>
...
X x; // means X{{}, {}}; that is the empty string and the empty vector{%endraw%}
~~~
