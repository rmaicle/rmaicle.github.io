...
draft: true
published: true
permalink: /doc/git-2.13.0/manual/ch1/sec1/git_show
group: git-2.13.0
subgroup: manual
---
...
:   The names of objects to show. For a more complete list of ways to spell object names, see "SPECIFYING REVISIONS" section in linkgit:gitrevisions\[7\].
